...
const fetchCashAdvance = () => {
    if (isMounted.value) {
        router.visit(route('cashAdvance.index', { from_date: filter.from_date, to_date: filter.to_date }), { preserveState: true });
    }
}
    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl  leading-tight">List of Cash Advance</h2>

                <!-- <div style="position:relative">
                    <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full px-9 p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search employee here" v-model="search">
                ...
                <div class="flex">
                    <Link class="button1 mb-2 py-2 px-3 bg-green-300 shadow border-gray-300 border hover:bg-green-400 rounded mr-3" as="button" href="/cashAdvance/create">Create Cash Advance</Link>
        ...
        <div >
            ...
            <h1 class="mt-4 text-xl font-semibold text-center  capitalize ">Filter Cash Advance Request Dates</h1>
           <div class=" ">
                <div class="max-w-lg px-8 py-4 mx-auto  dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <button @click="resetFilters" class="reset-button  py-2 px-3 bg-green-300 shadow border-gray-300 border hover:bg-green-400 rounded ml-3">
                            Reset
                        </button>
                    </div>
                </div>
            ...
            <div ref="tabs" class="p-8" >
                <div class="max-w-full mx-auto">
                    <div class="mb-4 flex space-x-4 p-2 rounded-lg shadow-md" :class="themeMode">
                        <button @click="openTab = 1" class="flex-1 py-2 px-4 rounded-md focus:outline-none focus:shadow-outline-green transition-all duration-300"  :class="{ 'bg-green-600 text-white': openTab === 1 }">
                        Cash Advance History
                        </button>
                        <button @click="openTab = 2"  class="flex-1 py-2 px-4 rounded-md focus:outline-none focus:shadow-outline-green transition-all duration-300"  :class="{ 'bg-green-600 text-white': openTab === 2 }">
                        Total Cash Advance
                        </button>

                    </div>

                    <div v-show="openTab === 1" class="transition-all duration-300  p-4 rounded-lg shadow-md border-l-4 border-green-900" :class="themeMode">
                        <h2 class="text-xl font-semibold mb-2 text-green-600">Employees Total Cash History</h2>
                        <table class="min-w-max w-full table-auto">
                            ...
                            <tbody class=" text-sm font-light" >
                                <tr v-if="cashAdvance.data.length === 0">
                                    <td colspan="7" class="text-center text-lg  text-gray-400 py-6">No cash advance record available</td>
                                </tr>
                    ...
                    <div v-show="openTab === 2" class="transition-all duration-300 p-4 rounded-lg shadow-md border-l-4 border-green-600" :class="themeMode">
                        <h2 class="text-xl font-semibold mb-2 text-green-600">Employee's Total Cash Advance</h2>
                        <table class="min-w-max w-full table-auto">
                            <thead>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">

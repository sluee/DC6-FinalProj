    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl leading-tight">Payslip for {{ employee.user.firstName}} {{ employee.user.lastName}}   </h2>
        ...
        <div class="py-5 ">
            ...
            <div v-if="payrollItem">
                <div class="max-w-xl mx-auto  p-8 shadow-md">
                    <img src="/images/logo.png" class="h-16 rounded-full  mx-auto" alt="Wage Wise.">
                        <div class="text-center text-sm">
                            <strong>Wage Wise</strong><br>
                           Skina Japan Street<br>
                    ...
                    <div class="mb-4">
                        <h3 class=" font-semibold "> Employee: {{payrollItem.employee.user.firstName }} {{ payrollItem.employee.user.lastName }}</h3>
                                <span class="block text-md font-normal ">Position: {{ payrollItem.employee.position.name }}</span>
                    ...
                    <p class="text-sm ">This payslip is for {{formattedDate(payrollItem.payroll.payrollPeriodFrom) }}-{{ formattedDate(payrollItem.payroll.payrollPeriodTo)}}. </p>

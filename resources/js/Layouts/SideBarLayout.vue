...
<template>
    ...
    <div id="app" class="flex flex-col min-h-screen">
        <div class="flex flex-1 min-h-screen">
            <div class="bg-green-600 text-white w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out " :class="width" >
                ...
                <div id="branding" class="mt-2" :class="hidden" >
                    <div class="flex items-center justify-center h-14 mb-5 border-gray-800">
                        ...
                        <span class="text-xl font-extrabold text-white my-5 px-4">Wage Wise</span>
                        </div>
            ...
            >
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between h-16">
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                ...
                                <span @click="toggleDarkMode" :class="themeMode === 'dark' ?'dark-button' : 'light-button'" class="absolute top-4 ml-2 right-4 h-8 w-8 bg-gray-500 rounded-full inline-flex items-center justify-center hover:bg-gray-400">
                ...
                <footer class=" footer footer-center text-center p-4 bg-base-300 text-base-content" :class="themeMode">
                    <aside>
                      <p class="text-center">© 2023 WageWise. All rights reserved.</p>
                    </aside>
                  </footer>
              </div>
        </div>
